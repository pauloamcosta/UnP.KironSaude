...
class ServidorList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $this->form = new BootstrapFormBuilder( "form_list_Servidor" );
        ...
        $opcao->addItems( [ "nome" => "Servidor", "numero_conselho" => "Conselho","cargo_id" => " Cargo", "setor_id" => " Setor" ] );

        $this->form->addFields( [ new TLabel( "Opção de busca:" ) ], [ $opcao ] );
        $this->form->addFields( [ new TLabel( "Dados à buscar:" )  ], [ $dados ] );

        $this->form->addAction( "Buscar", new TAction( [ $this, "onSearch" ] ), "fa:search" );
        $this->form->addAction( "Cadastrar Servidor", new TAction( [ "ServidorForm", "onEdit" ] ), "bs:plus-sign green" );
        ...
        $nome = new TDataGridColumn( "nome", "Servidor", "left" );
        $numero_conselho       = new TDataGridColumn( "numero_conselho", "Numero do Conselho", "left" );
        $cargo  = new TDataGridColumn( "cargo_id", "Cargo do Servidor ID", "left" );
        $setor  = new TDataGridColumn( "setor_id", "Setor ID", "left" );

        $this->datagrid->addColumn( $nome );
        $this->datagrid->addColumn( $numero_conselho );
        $this->datagrid->addColumn( $cargo );
        $this->datagrid->addColumn( $setor );

        $action_edit = new TDataGridAction( [ "ServidorForm", "onEdit" ] );
