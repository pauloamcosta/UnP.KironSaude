...
class EscalaList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $this->form = new BootstrapFormBuilder( "form_list_escala" );
        $this->form->setFormTitle( "Listagem Escala" );
        ...
        $this->form->addAction( "Nova Escala", new TAction( [ "EscalaForm", "onEdit" ] ), "bs:plus-sign green" );
        ...
        $column_dia_semana_inicio = new TDataGridColumn( "dia_semana_inicio", "Escala", "left" );

        $this->datagrid->addColumn( $column_dia_semana_inicio );

        $action_edit = new TDataGridAction( [ "EscalaForm", "onEdit" ] );
    ...
    function Delete( $param = NULL )
    {
        try {
            ...
            TTransaction::open( "database" );
                $object = new EscalaRecord( $param[ "key" ] );
                $object->delete();
            TTransaction::close();
