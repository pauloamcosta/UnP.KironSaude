...
class AfastamentoList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $opcao->addItems( [ "servidor_id" => "servidor_id" ] );

        $this->form->addFields( [ new TLabel( "Opção de busca:" ) ], [ $opcao ] );
        $this->form->addFields( [ new TLabel( "Dados à buscar:" )  ], [ $dados ] );

        $this->form->addAction( "Buscar", new TAction( [ $this, "onSearch" ] ), "fa:search" );
        $this->form->addAction( "Novo", new TAction( [ "AfastamentoForm", "onEdit" ] ), "bs:plus-sign green" );
        ...
        $servidor_id = new TDataGridColumn( "Afastamento", "ServidorID", "left" );

        $this->datagrid->addColumn( $servidor_id );

        $action_edit = new TDataGridAction( [ "AfastamentoForm", "onEdit" ] );
    ...
    public function onReload( $param = NULL )
    {
        try {
            ...
            $repository = new TRepository( "AfastamentoRecord" );
