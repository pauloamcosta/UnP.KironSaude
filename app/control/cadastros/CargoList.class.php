...
class CargoList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $this->form = new BootstrapFormBuilder( "form_list_cargo" );
        $this->form->setFormTitle( "Listagem Cargo" );
        ...
        $this->form->addAction( "Novo", new TAction( [ "CargoForm", "onEdit" ] ), "bs:plus-sign green" );
        ...
        $column_descricao = new TDataGridColumn( "descricao", "Cargo", "left" );

        $this->datagrid->addColumn( $column_descricao );

        $action_edit = new TDataGridAction( [ "CargoForm", "onEdit" ] );
